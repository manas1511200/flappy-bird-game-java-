...
class flappyBird extends JPanel {
        ...
        addKeyListener(new KeyAdapter() {
            ...
            public void keyPressed(KeyEvent e) {
                ...
                if (e.getKeyCode() == KeyEvent.VK_ESCAPE) {
                    closeGame();  // Close the game when ESC is pressed
                }
                if (e.getKeyCode() == KeyEvent.VK_ENTER) {
                    restartGame();  // Restart the game when Enter key is pressed
                }
            }
        });
    ...
    private void saveScore() {
        try {
            ...
            if (attempt.exists()) {
                ...
                if (attemptNumber.isEmpty()) attemptNumber = "0";
    ...
    private void showPopup() {
        ...
        if (popupState == 0) {
            ...
            exit.addActionListener(e -> System.exit(0));  // Exit the game when "EXIT" is clicked
    ...
    private void closeGame() {
        ...
        if (frame != null) {
            frame.dispose();  // Close the window when ESC is pressed
        }
    }
